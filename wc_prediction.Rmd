...
match1rep <- tibble(outcome = replicate(n = 1000, prediction(proj_score1 = 2.03, proj_score2 = 0.73)))
match1rep <- match1rep %>% group_by(outcome) %>% summarise(total = n())
match1rep <- match1rep %>% mutate(prop = total / 1000)



results_vec <- purrr::map(1:1000, ~ prediction(proj_score1 = 2.03, proj_score2 = 0.73)) |>
  unlist()
